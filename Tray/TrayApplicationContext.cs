...
internal sealed class TrayApplicationContext : ApplicationContext
{
    ...
    public TrayApplicationContext()
    {
        ...
        _showSettingsEvent = SingleInstance.ShowSettingsEvent;
        _ = _loopForm.Handle;
        ThreadPool.RegisterWaitForSingleObject(
            _showSettingsEvent,
            (_, _) => _loopForm.BeginInvoke(OpenSettings),
            null,
            Timeout.Infinite,
            false);
    ...
    private void OpenSettings()
    {
        using var form = new SettingsForm(new AppSettings
        {
            ...
            HideTrayIcon = _settings.HideTrayIcon,
        ...
        var trayVisibilityChanged = _settings.HideTrayIcon != form.Settings.HideTrayIcon;

        _settings.WatchFolder = form.Settings.WatchFolder;
        _settings.StartAtLogin = form.Settings.StartAtLogin;
        _settings.HideTrayIcon = form.Settings.HideTrayIcon;
        ...
        {
            MessageBox.Show(L.HideTrayHint, L.AppTitle, MessageBoxButtons.OK, MessageBoxIcon.Information);
        }
    }
    ...
    {
        _tray.Visible = !_settings.HideTrayIcon;
        if (_tray.Visible)
            UpdateTooltip();
    }
